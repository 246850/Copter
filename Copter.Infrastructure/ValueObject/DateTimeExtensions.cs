...
namespace Copter.Infrastructure.ValueObject
{
    ...
    public static class DateTimeExtensions
    {
        ...
        {
            return Convert.ToInt64(datetime.Subtract(TimeZone.CurrentTimeZone.ToLocalTime(new DateTime(1970, 1, 1, 0, 0, 0, 0))).TotalSeconds);
        }
        /// <summary>
        /// 时间戳 转 DateTime
        /// </summary>
        ...
        public static DateTime AsDateTime(this long timestamp)
        {
            ...
            return TimeZone.CurrentTimeZone.ToLocalTime(new DateTime(1970, 1, 1, 0, 0, 0, 0)).Add(date);
        }
