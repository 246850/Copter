...
namespace Copter.Infrastructure.Security
{
    ...
    public class RsaCryptor : ICryptor
    {
        ...
        public string Encrypt(string source, string exponent, string modulus, Encoding encoding)
        {
        ...
        public string Decrypt(string source, string rsaPrivateKey, Encoding encoding)
        {
            using (RSACryptoServiceProvider rsaProvider = new RSACryptoServiceProvider())
            {
